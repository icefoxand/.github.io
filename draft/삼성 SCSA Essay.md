...
- ##### 1-1. 삼성SDS를 지원한 이유와,
  ...
  - why 그 업계인가? why 하필 삼성SDS인가? 대기업 SI(시스템 통합) 회사.
...
- ##### [선택] 3. 본인의 대표적인 개발 경험이나 희망 분야 관련 과제 성과, 활동 등을 가장 잘 보여줄 수 있는 Github, 블로그 등의 URL을 작성하시거나 자료를 첨부하시고, 간단한 소개나 설명을 해 주세요. 공동 프로젝트였다면 본인의 역할을 명확히 써 주세요.[1000자]
  ...
  * 널널한개발자 - 네트워크 강의
  * Marktext 컨트리뷰션 할것 있나?

# 만능자소서

- 관심있는 개발 분야 소개: 
  
  - <mark>FE 에 관심을 가진 이후의 행동</mark>에 초점을 맞추기.
...
- 기억에 남는 개발 프로젝트: <mark>Travel Maker</mark>. 
...
Q. CBDC 관련 우리은행이 준비하는 것이 있는지?

- 아직 중앙은행에서 법적 검토나 시스템 형성이 안끝남. 그래서 아직 대응x.

- 내부적으로 사용하는 토큰(코인)을 만들긴 했음. 

- 칭찬받을 일이 있는 사람한테 자신의 코인을 보내서 블록체인적으로 기록하는 중.

Q. 애플 인앱 결제

- 금융 관련 라이센스 산업에서, 기존 시중은행이 보호 받았던 시장들이 점점 규제 완화중

- 신한은행: 땡겨요(배달음식)

- 국민은행: 리브앱(부동산)

- 기존 은행들의 영역이 열리는 만큼, 기존 은행들이 타 영역으로 진출하는 것도 더 활발해지는 중

Q. 서비스기업의 페이 시스템과, 전통 은행 혹은 인터넷 중심 은행의 결제 시스템은 다른가?

- 그건 모르겠고... 현실적으로 시중은행보다 앞서나가고 있는 인터넷뱅크의 시스템. 
